...
const DEFAULT_FIRST_SNAPSHOT_AT = "2026-07-11T02:00:00-04:00";
...
export const FIRST_SNAPSHOT_AT = process.env.NEXT_PUBLIC_FIRST_SNAPSHOT_AT?.trim() || DEFAULT_FIRST_SNAPSHOT_AT;
...
export const FIRST_SNAPSHOT_COPY = "2:00 AM ET";
export const SNAPSHOT_TIMING_COPY = `locks at ${FIRST_SNAPSHOT_COPY}, then launch follows ${FIRST_LAUNCH_WINDOW_COPY}`;
