          ...
          <div className="container hero-inner">
            <div className="hero-copy-stack">
              ...
              <p className="hero-lead">
                The 50/50 engine splits rewards between active HoodX holders and early Hood chain token picks,
                with live holder data, airdrop history, and on-chain receipts kept on the page.
              </p>
          ...
          <div className="container">
            ...
            <div className="section-head split-head">
              ...
              <p>
                ...
                while the other half keeps buying early Hood chain tokens and picks one holder every two hours.
            ...
            <div className="hood-rail-grid">
              ...
              <article>
                <span>50%</span>
                <strong>Hood Chain Picks</strong>
                <p>Buys early Hood chain tokens and picks one holder every 2 hours for an extra airdrop.</p>
              </article>
            </div>
          </div>
        </section>
