...
const SITE_DESCRIPTION = "Sherwood Run is a Robin Hood arcade runner where 1M+ holders compete for top-15 HoodX drops every 30 minutes on a 24-hour leaderboard.";
